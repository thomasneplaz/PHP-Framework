...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel')) && false ?: '_'}, ($this->targetDirs[3].'/src'), array(($this->targetDirs[3].'/templates') => NULL, ($this->targetDirs[3].'/vendor/symfony/twig-bridge/Resources/views/Form') => NULL)));
