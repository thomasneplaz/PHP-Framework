...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\SallesRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\SallesRepository']) ? $this->services['App\Repository\SallesRepository'] : $this->load('getSallesRepositoryService.php')) && false ?: '_'};
