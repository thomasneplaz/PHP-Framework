...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'app\\controller\\sallescontroller' => 'App\\Controller\\SallesController',
            'app\\controller\\usercontroller' => 'App\\Controller\\UserController',
            'app\\form\\sallestype' => 'App\\Form\\SallesType',
            'app\\form\\usertype' => 'App\\Form\\UserType',
            'app\\repository\\sallesrepository' => 'App\\Repository\\SallesRepository',
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\SallesController' => 'getSallesControllerService.php',
            'App\\Controller\\UserController' => 'getUserControllerService.php',
            'App\\Form\\SallesType' => 'getSallesTypeService.php',
            'App\\Form\\UserType' => 'getUserTypeService.php',
            'App\\Repository\\SallesRepository' => 'getSallesRepositoryService.php',
            ...
            'service_locator.hwuuob5' => 'getServiceLocator_Hwuuob5Service.php',
        ...
        $this->privates = array(
            ...
            'App\\Form\\SallesType' => true,
            'App\\Form\\UserType' => true,
            'App\\Repository\\SallesRepository' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tM1NhFO2f-', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XpWvqb+BCU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7VfV8OnsAW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UmkBNc4OS2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hKvJJlyW1H', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
