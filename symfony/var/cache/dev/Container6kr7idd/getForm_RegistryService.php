...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\SallesType' => function () {
    return ${($_ = isset($this->services['App\Form\SallesType']) ? $this->services['App\Form\SallesType'] : $this->services['App\Form\SallesType'] = new \App\Form\SallesType()) && false ?: '_'};
