...
// Returns the private 'App\Repository\ModuleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ModuleRepository.php';

return $this->services['App\Repository\ModuleRepository'] = new \App\Repository\ModuleRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
