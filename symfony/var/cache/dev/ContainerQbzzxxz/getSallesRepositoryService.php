...
// Returns the private 'App\Repository\SallesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SallesRepository.php';

return $this->services['App\Repository\SallesRepository'] = new \App\Repository\SallesRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
