...
class ModuleController extends Controller
{
    ...
    /**
     * @Route("/{idModule}", name="module_show", methods="GET")
     */
    ...
    /**
     * @Route("/{idModule}/edit", name="module_edit", methods="GET|POST")
     */
    public function edit(Request $request, Module $module): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('module_edit', ['idModule' => $module->getIdModule()]);
        }
    ...
    /**
     * @Route("/{idModule}", name="module_delete", methods="DELETE")
     */
    public function delete(Request $request, Module $module): Response
    {
        if ($this->isCsrfTokenValid('delete'.$module->getIdModule(), $request->request->get('_token'))) {
            $em = $this->getDoctrine()->getManager();
            $em->remove($module);
            $em->flush();
        }
